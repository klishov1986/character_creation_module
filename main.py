...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от каласса выбранного персонажа получает разный урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимотсти от класса выбранного персонажа получает разную защиту."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от класса выбранного персонажа применяет
